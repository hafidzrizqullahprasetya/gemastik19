...
\addcontentsline{toc}{subsection}{F.5 Biodata Anggota Tim}
...
\subsection*{F.6 Evaluasi Model (Dataset EMSCAD)}
...
\section*{G.\quad Mockup Antarmuka (Hasil Uji End-to-End)}
\addcontentsline{toc}{section}{G. Mockup Antarmuka (Hasil Uji End-to-End)}

...
\midrule
OSINT: Alamat \& Form & OpenStreetMap (Nominatim), Google Form inspector & Validasi lokasi dan keberadaan bisnis pada peta + inspeksi form phishing/permintaan dokumen sensitif \\
\midrule
...
\midrule
ORM & SQLAlchemy & Akses data ORM; evolusi skema dilakukan via migrasi SQL manual (\texttt{ALTER TABLE ... IF NOT EXISTS}) \\
\midrule

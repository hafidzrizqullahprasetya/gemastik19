...
# 9. Fix TikZ Diagram E.3 Overlap (Shrinking the nodes so it fits naturally instead of resizebox)
old_tikz_setup = r"""\begin{tikzpicture}[
  node distance=0.6cm,
...
new_tikz_setup = r"""\begin{tikzpicture}[
  node distance=0.4cm,
...
content = content.replace(old_tikz_setup, new_tikz_setup)

# 10. Fix Poin D XAI Math and features that were reverted by the git checkout

Riset utama yang melandasi teknologi TB Vector milik Tim DoAlert
  (ITS) berasal dari kolaborasi riset terbaru (tahun 2025) antara
  pembimbing mereka, Dr. Eng. Dhany Arifianto, dengan laboratorium
  pengolahan bahasa/sinyal suara nasional.
  ...
  │
  │ (Perbandingan Suara Batuk yang Diarahkan dan Suara Batuk
  │ Longitudinal/Alami untuk Deteksi Tuberkulosis)

  • Para Penulis (Authors): Aprianto Dwi Prasetyo, Bagus Tris Atmaja,
  Dhany Arifianto (Dospem DoAlert), dan Sakriani Sakti.
  ...
  • Ketika jumlah data rekaman alami (longitudinal) diperbanyak
  secara masif di lingkungan tidak terkontrol, akurasi klasifikasi
  AI-nya melonjak drastis hingga 91%!
  • Penemuan ini membuktikan bahwa pemantauan pasif berbasis suara di
  ruang publik secara klinis sangat layak dan memiliki akurasi yang
  jauh lebih tinggi jika diprogram dengan data skala besar.
  ──────
...
\begin{itemize}
    ...
    \item \textbf{Repository GitHub Dokumen \& Proposal:} \url{https://github.com/hafidzrizqullahprasetya/gemastik19}
    \item \textbf{Video Rancangan Perangkat Lunak (YouTube):} Tautan dicantumkan pada berkas \texttt{URL\_Video\_Demo.txt}.
\end{itemize}
